...
function App() {
    ...
    <div>
          ...
          <div className='main-header'>
            <div className="top-header">
              ...
              <div className="right-top-header">
                <a href="dangnhap.html" className="login-btn"><i className="fas fa-user"></i> Đăng nhập</a>
            ...
            <div className="bottom-header">
              ...
              <div className="right-bottom-header">
                <a href="danhmucsanpham.html" className="nav-link">
      ...
      <div className="cart-overlay hidden" >
        <div className="cart">
          ...
          <a href="danhmucsanpham.html"><button>Tiếp tục mua sắm</button></a> 
        </div>
      </div>
      <main>
  ...
  <div className="copyright">
    <small>
      Công ty vô vàn trách nhiệm 3 thành viên. Tòa nhà chọc trời, P. Yên Nghĩa,
      Q. Hà Đông, TP Hà Nội
    </small>
    <h4>Copyright © 2024. All rights has not reserved</h4>
  </div>
</footer>;
